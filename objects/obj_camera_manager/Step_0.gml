...
//	target_w = _cam_w;
//	target_h = _cam_h;
//	target_x = mouse_x - target_w / 2;
//	target_y = mouse_y - target_h / 2;
//}
...
var _new_x = lerp(_cam_x + _cam_w/2, camera_target_x, _move_rate);
var _new_y = lerp(_cam_y + _cam_h/2, camera_target_y, _move_rate);

camera_set_view_pos(_cam, _new_x - _cam_w/2, _new_y - _cam_h/2);
